...
```
cd ../deploy/
docker build -t registry.dpi.inpe.br/inpe-cdsr/catalog-frontend:0.0.10 -f prod.Dockerfile . --no-cache
```

You can send the image above to your registry:

```
docker push registry.dpi.inpe.br/inpe-cdsr/catalog-frontend:0.0.10
```
